...
```mermaid
quadrantChart
    title Agentic AI 工程师技能雷达
    x-axis "基础" --> "进阶"
    y-axis "理论" --> "实战"
    "Python 工程": [0.8, 0.9]
    "LLM 原理": [0.7, 0.6]
    "Context Engineering": [0.7, 0.8]
    "框架使用": [0.8, 0.9]
    "RAG 系统": [0.8, 0.8]
    "记忆工程": [0.6, 0.7]
    "多智能体": [0.7, 0.7]
...
*上一阶段：[← 生产部署](/tools/agentic-ai/09-production) | [下一阶段：可观测性 →](/tools/agentic-ai/11-evaluation-observability)*
