...
| 人群 | 学习路径 | 收获 |
|------|----------|------|
| **AI 解决方案架构师** | FDE 系统学习 | 掌握从 GPU 底层到生产部署的完整架构能力 |
| **AI Agent 工程师** | Agentic AI 系统学习 | LangGraph、RAG、多智能体编排、MCP 协议 |
| **校招 / 实习生** | Agentic AI 系统学习 | 从 Python 基础到实战项目，一条路径直达 |
| **转行 AI 的开发者** | 双路径并行 | Transformer → Agent 全栈能力 |
| **技术负责人** | FDE 系统学习 | 团队建设、招聘体系、技术选型、成本管控 |
...
| 模块 | 路由 | 内容量 | 适合人群 | 说明 |
|------|------|--------|----------|------|
| **FDE 系统学习** | `/` | 15 个阶段 | **AI 解决方案架构师** | AI 基础 → GPU → 推理引擎 → 分布式 → 生产部署 → 面试 → 团队管理 |
| **Agentic AI 系统学习** | `/agentic-ai/` | 20 篇 | **AI Agent 工程师 / 校招 / 实习生** | Python 基础 → LLM → 上下文工程 → Harness → LangGraph → RAG → 多智能体 → 实战项目 |
